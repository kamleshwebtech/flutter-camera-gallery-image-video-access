...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Image / Video Picker',
      theme: ThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Flutter Image / Video Picker"),
      ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  color: Colors.green,
                  child: Text("Pick Video From Gallery", style: TextStyle(color:Colors.white),),
                ),
                SizedBox(
                  height: 5.0,
                ),
                ...
                RaisedButton(
                  ...
                  color: Colors.green,
                  child: Text("Pick Video From Camera", style: TextStyle(color:Colors.white),),
                )
              ],
            ),
          ),
